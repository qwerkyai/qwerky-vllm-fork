...
def _mamba_chunk_scan_combined_fwd(
    ...
    # - for handling chunked prefill, this requires initial_states and
    #   last_chunk_indices to be specified.
    # - The kernel iterates per-sequence using last_chunk_indices to derive
    #   chunk ranges, applying initial_states at each sequence boundary.
